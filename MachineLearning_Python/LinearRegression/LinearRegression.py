...
def plotJ(J_history,num_iters):
    ...
    #plt.show()
    plt.savefig('./Iterative_change_graph.png')
...
def predict(mu,sigma,theta):
    ...
    print ('norm_predict:',norm_predict)
    final_predict = np.hstack((np.ones((1)),norm_predict))#将norm_predict由原来的[1650,3]扩展为[1,1650,3]
